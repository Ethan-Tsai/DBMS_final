...
<!-- Footer -->
    ...
    <div class="fw-semibold text-dark"><?php echo $member_name?></div>
                                  <div class="fw-semibold text-dark">Email:</div>
                                  <div class="fs-sm text-muted"><?php echo $member_email ?></div>
                                  <div class="fw-semibold text-dark">Department:</div>
                                  <div class="fs-sm text-muted"><?php echo $member_department ?></div>
